...
export function SmileyBall({
  ...
  return (
    <motion.div
      ...
      transition={isSneezing ? { duration: 0.2, repeat: 2 } : undefined}
      style={{
        position: 'absolute',
        display: 'flex',
        alignItems: 'center',
            ...
            <div key={i} style={{ position: 'relative' }}>
              ...
              >
                <svg width={size * 0.18} height={size * 0.15} viewBox="0 0 40 30" style={{ overflow: 'visible' }}>
                  <defs>
                    <linearGradient id={`lashGrad-${i}-${size}`} x1="0%" y1="0%" x2="0%" y2="100%">
              ...
              <motion.div
                ...
                transition={state === 'confused' ? { repeat: Infinity, duration: 1.8, delay: i * 0.2 } : undefined}
              >
                <motion.div
