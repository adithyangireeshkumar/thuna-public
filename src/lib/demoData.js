...
export const QUICK_REFERENCES = ["Wanted Persons", "Missing Reports", "District Directory"];
...
export function filterCases(records, query, filters) {
...
export function deriveDashboardStats(records) {
...
export function mapIncidentsFromCases(records) {
  return records.map((record, index) => ({
    ...
    time: record.filedDate.includes("2023") ? `${14 - index}:0${index + 2} IST` : `${12 + index}:10 IST`,
